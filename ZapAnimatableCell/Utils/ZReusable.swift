...
public extension UITableView {
    func registerCellNib<T: Nibable>(_ classType: T.Type) where T: ZReusable { register(classType.nib, forCellReuseIdentifier: classType.reusableIdentifier) }
    ...
    func registerHeaderFooterNib<T: Nibable>(_ classType: T.Type) where T: ZReusable { register(classType.nib, forHeaderFooterViewReuseIdentifier: classType.reusableIdentifier) }
...
public extension UICollectionView {
    func registerCellNib<T: Nibable>(_ classType: T.Type) where T: ZReusable { register(classType.nib, forCellWithReuseIdentifier: classType.reusableIdentifier) }
    ...
    func registerSupplementaryViewNib<T: Nibable>(_ classType: T.Type, kind: String) where T: ZReusable { register(classType.nib, forSupplementaryViewOfKind: kind, withReuseIdentifier: classType.reusableIdentifier) }
